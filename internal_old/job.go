...
// TODO: use struct inheritance of *api.CompileResponse, and pass InputOutput to the runner
// to reduce memory usage and speed up the transition from Job to api.CompileResponse in the
// GRPC handler
type Job struct {
	ID string
